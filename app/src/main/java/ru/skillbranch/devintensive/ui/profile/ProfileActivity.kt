...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
       ...
       // outState?.putString("STATUS", benderObj.status.name)
        //State?.putString("QUESTION", benderObj.question.name)

       // Log.d("M_MainActivity","onSaveInstanceState ${benderObj.status.name}")
       //og.d("M_MainActivity","onSaveInstanceState ${benderObj.question.name}")
    }
    private fun initViews(savedInstanceState: Bundle?) {
       ...
       /* с вынесенной лямбдой, если единственный аргумент
